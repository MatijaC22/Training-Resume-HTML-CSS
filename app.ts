...
window.addEventListener("scroll", function () { 
    ...
    if (st >= lastScrollTop) {
        ...
        // picture movement
        (document.getElementById("image4") as HTMLImageElement).src = "pictures/ohNO.jpg";
        ...
        if (st >= 137.5) {
            ...
            let result = stringRezultat.concat('px');
        ...
        //picture movement
        (document.getElementById("image4") as HTMLImageElement).src = "pictures/push.jpg";
